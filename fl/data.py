...
def build_datasets(cfg):
    ...
    if name == "CIFAR10":
        ...
        train_ds = datasets.CIFAR10(root="~/autodl-tmp", train=True, download=False, transform=tfm)
        test_ds = datasets.CIFAR10(root="~/autodl-tmp", train=False, download=False, transform=tfm)

...
def build_datasets(cfg):
    ...
    if name == "CIFAR10":
        ...
        train_ds = datasets.CIFAR10(root="~/autodl-pub/cifar-10", train=True, download=False, transform=tfm)
        test_ds = datasets.CIFAR10(root="~/autodl-pub/cifar-10", train=False, download=False, transform=tfm)
